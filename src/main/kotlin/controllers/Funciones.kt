...
fun insertarBars(): Pair<List<Bar>, List<Bar>> {
    ...
    val bar2 = BarExterior("Terraza del Sol", "Plaça Mayor", obtenerFechaConHora(10, 0), obtenerFechaConHora(23, 0), 80, 40)
    val bar3 = BarInterior("La Esquina", "C/ Valencia", obtenerFechaConHora(9, 0), obtenerFechaConHora(20, 0), 50)
    val bar4 = BarExterior("Patio Andaluz", "C/ Andalucia", obtenerFechaConHora(11, 0), obtenerFechaConHora(21, 30), 70, 40)
    val bar5 = BarInterior("El Bistró", "C/ Paris", obtenerFechaConHora(8, 0), obtenerFechaConHora(19, 0), 45)
    val bar6 = BarExterior("Sunny Garden", "Av. de los Jardines", obtenerFechaConHora(9, 0), obtenerFechaConHora(22, 0), 60, 30)
    val bar7 = BarInterior("Fiesta Latina", "C/ Salsa", obtenerFechaConHora(10, 0), obtenerFechaConHora(23, 30), 80)
    val bar8 = BarExterior("Riverside Lounge", "C/ River", obtenerFechaConHora(12, 0), obtenerFechaConHora(22, 30), 75, 40)
    ...
    val bar12 = BarExterior("Sunset Terrace", "C/ Sunset", obtenerFechaConHora(8, 0), obtenerFechaConHora(21, 0), 40, 20)
    val bar13 = BarInterior("Café de la Plaza", "Plaça de l'Ajuntament", obtenerFechaConHora(9, 0), obtenerFechaConHora(22, 30), 90)
    val bar14 = BarExterior("Sea View Lounge", "Av. del Mar", obtenerFechaConHora(10, 0), obtenerFechaConHora(22, 0), 55, 25)
